<?php        
    ...
    if(isset($_POST["enviar"])){
        ...
        // para almacenar usuariossssssssssss (ya no solo uno)
        $usuarios=["adrian"=>"4321", "alejandra"=>"1234", "juan" =>"5678"];
        ...
        foreach($usuarios as $usuario=>$password){
            if($usuario == $usuarioFormulario && $password == $passwordFormulario){
                $autenticado=true;
                session_start();
