<?php
    ...
    //Cuando mostramos la página con el formulario y los datos del producto
    if (!isset($_GET['id'])) { //Si no nos pasan el id del producto        
    ...
    //Cuando nos envían los datos del producto desde el formulario y tenemos que actualizarlo
...
<?php require "templates/header.php"; ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="mt-4">Editando el producto <?= escapar($nombre) . ' ' . escapar($nombre)  ?></h2>
        <hr>
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea type="text" name="descripcion" id="descripcion" class="form-control"><?= escapar($descripcion) ?> </textarea>
          </div>
          <div class="form-group">
          ...
          <?php
            ...
            if($imagen!=""){ // si es distinta de la imagen vacía, mostramos la imagen (esto anotado yo 25/10/2023 8:41s)
              $ruta= "/tienda/img";
